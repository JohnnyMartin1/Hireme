...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-8" style={{background: 'linear-gradient(170deg, #F3F7FF 0%, #E6F2FF 40%, #F8FAFC 100%)'}}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200/60">
          {/* Error Banner */}
          {err && (
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="relative">
              <input
                name="email"
                type="email"
                className="w-full bg-form-bg border border-gray-200 rounded-xl py-4 px-4 text-navy placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue focus:bg-white transition-all duration-300"
                placeholder="Email"
                autoComplete="email"
                value={email}
            ...
            <div className="relative">
              <input
                name="password"
                type="password"
                className="w-full bg-form-bg border border-gray-200 rounded-xl py-4 px-4 pr-12 text-navy placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue focus:bg-white transition-all duration-300"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-navy text-white font-semibold py-4 px-4 rounded-xl hover:bg-blue-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
            >
              {isLoading ? (
