...
export default function MessagesError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="min-h-[40vh] flex flex-col items-center justify-center px-4 text-center">
      <h1 className="text-lg font-semibold text-navy-900 mb-2">Messages could not be loaded</h1>
      <p className="text-sm text-slate-600 mb-4 max-w-md">Try reloading this section.</p>
