      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <aside className="md:col-span-1 bg-white rounded shadow p-4">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link className="text-blue-600 hover:underline" href="/account/profile">Edit profile</Link></li>
            <li><Link className="text-blue-600 hover:underline" href="/account/uploads">Resume & video</Link></li>
          ...
          <div className="mt-6">
            ...
            <div className="space-y-2 text-sm">
              <Link className="text-blue-600 hover:underline" href="/account/profile">Edit profile</Link><br />
              <Link className="text-blue-600 hover:underline" href="/messages">Open inbox</Link>
            </div>
          </div>
        </aside>
