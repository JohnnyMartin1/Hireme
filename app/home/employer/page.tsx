      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <aside className="md:col-span-1 bg-white rounded shadow p-4">
          ...
          <ul className="space-y-2 text-sm">
            <li><Link className="text-blue-600 hover:underline" href="/account/company">Company profile</Link></li>
            <li><Link className="text-blue-600 hover:underline" href="/account/security">Security</Link></li>
            <li><Link className="text-blue-600 hover:underline" href="/employer/job/new">Post a job</Link></li>
          </ul>

          <div className="mt-6">
            <h3 className="font-semibold mb-2">Quick Actions</h3>
            <div className="space-y-2 text-sm">
              <Link className="text-blue-600 hover:underline" href="/search/candidates">Search candidates</Link><br />
              <Link className="text-blue-600 hover:underline" href="/saved/candidates">Saved candidates</Link>
            </div>
          </div>
        </aside>
                  ...
                  <li key={m.id} className="py-3">
                    <Link href={`/messages/${m.threadId}`} className="block hover:bg-gray-50 rounded p-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-xs text-gray-500">{m.createdAt.toLocaleString()}</div>
                      </div>
                    </Link>
                  </li>
                );
